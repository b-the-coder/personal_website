...
const mockMultipleAnnotations = {
  "resume-header": {
    "9d62802b-59b7-4c05-abfd-a9fee7a3900e": [13, 17],
    "3ff6b34f-3559-4196-83d1-0fc349758db7": [5, 9],
    "08a30d74-77aa-407f-a592-237b1470be8f": [15, 19],
    "60ac3373-0bf4-4b08-9ee8-3e2d417cb6b3": [3, 13],
  },
};
...
describe("Header", () => {
  test("correctly render Header section with single annotation", () => {
  ...
  test("correctly render Header section with multiple annotationss", () => {
    const headerDiv = `<div class="resumeHeader" data-text-id="resume-header"><h2>Bin<span class="highlight highlight-1" data-annotation-ids="60ac3373-0bf4-4b08-9ee8-3e2d417cb6b3"> (</span><span class="highlight highlight-2" data-annotation-ids="3ff6b34f-3559-4196-83d1-0fc349758db7,60ac3373-0bf4-4b08-9ee8-3e2d417cb6b3">Emma</span><span class="highlight highlight-1" data-annotation-ids="60ac3373-0bf4-4b08-9ee8-3e2d417cb6b3">) He</span></h2><div><p><span class="highlight highlight-1" data-annotation-ids="9d62802b-59b7-4c05-abfd-a9fee7a3900e">em</span><span class="highlight highlight-2" data-annotation-ids="9d62802b-59b7-4c05-abfd-a9fee7a3900e,08a30d74-77aa-407f-a592-237b1470be8f">ma</span><span class="highlight highlight-1" data-annotation-ids="08a30d74-77aa-407f-a592-237b1470be8f">hs</span>de@gmail.com</p><p>Greater NYC Area</p></div></div>`;
    const { container } = render(
      <Header annotationList={mockMultipleAnnotations} />
    );
...
describe("Contact", () => {
  test("correctly render Contact section with single annotation", () => {
...
describe("Skills", () => {
  test("correctly render Skills section with single annotation", () => {
...
describe("Experience", () => {
  test("correctly render Experience section with single annotation", () => {
...
describe("Projects", () => {
  test("correctly render Projects section with single annotation", () => {
...
describe("Education", () => {
  test("correctly render Education section with single annotation", () => {
